...
images = glob(os.path.sep.join([args["output"], "*.png".format(saved)]))
saved = len(images)
...
"""
 python gather_examples.py --input videos/real_jin2.mp4 --output dataset/real \
	--detector face_detector --skip 8
"""